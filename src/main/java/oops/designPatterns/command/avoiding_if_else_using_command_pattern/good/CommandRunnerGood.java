package oops.designPatterns.command.avoiding_if_else_using_command_pattern.good;


import oops.designPatterns.command.avoiding_if_else_using_command_pattern.good.executors.CommandExecutor;
