...
public class URLShortener {
  ...
  final private HashMap<String, String> keyMap; // key-url map
  final private HashMap<String, String> valueMap;// url-key map to quickly check
  // whether an url is
  ...
  private final char[] myChars; // This array is used for character to number
  // mapping
  private final Random myRand; // Random object used to generate random integers
