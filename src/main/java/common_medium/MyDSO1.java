...
/*
We can use hashing(hashmap) to support first 3 operations in Θ(1) time. How to do the 4th operation?
...
To implement getRandom(), we can simply pick a random number from 0 to size-1 (size is the number of current elements)
