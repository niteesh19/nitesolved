...
// Java program to find the smallest positive value that cannot be represented as sum of subsets of a given sorted array
class SmallestInt
{
  ...
  {
    SmallestInt small = new SmallestInt();
    int arr1[] = {1, 3, 4, 5};
    int n1 = arr1.length;
