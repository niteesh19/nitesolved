package lld.parking_lot.filebase;
...
and the colour of the car and allocating an available parking slot to the car before actually handing over a ticket to the driver
...
The system should allow input in two ways. Just to clarify,
